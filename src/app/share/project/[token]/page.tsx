      ...
      {showTeamSection ? (
        <section>
          ...
          <ul className="grid items-stretch gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {manager ? (
              <li className="flex h-full flex-col items-center justify-center gap-2 rounded-md border border-[var(--border)] bg-[var(--bg)] p-3 text-center">
                <PersonAvatar
            ...
            {teamWithoutManager.map((member) => (
              <li
                key={member.id}
                className="flex h-full flex-col items-center justify-center gap-2 rounded-md border border-[var(--border)] bg-[var(--bg)] p-3 text-center"
              >
                <PersonAvatar
